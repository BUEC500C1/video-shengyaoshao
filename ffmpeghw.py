...
consumer_key = 'wA8Vbx45oG18WsTlA6vu4AJs8'
consumer_secret = 'gj7ojv6Y8QJZJsB6Fm15Yi1Ru8K8KtIbJU7DzSqtBWqaTZXAIi'
access_key = '1173709326113890304-UfnOIBwVtnl2ES81jvQGJfKRMiGfqr'
access_secret = 'qbfUimy3bV4Mdi3tBQdd61akUS7tKMUVv24JXk8WEgJmr'
...
def get_all_tweets(account1,number1):
        ...
        while (int(number) > 200):
                return 'The number you entered is biger than 200, please enter a number less than 200'
        try:
                new_tweets = api.user_timeline(screen_name = account,count=1)
        except:
                return 'This is not a valid Twitter account'
        alltweets.extend(new_tweets)
        try:
                oldest = alltweets[-1].id - 1
        except:
                return 'This account does not have this many tweets'
        tweetnum = 1
                ...
                if response.error.message:
                        raise Exception(
                                ...
                                'https://cloud.google.com/apis/design/errors'.format(
                                        response.error.message))
                file_name += 1
def Image2Video(filenumber):
        subprocess.call('ffmpeg -framerate 1/3 -start_number 1 -i C:/Users/Vanquish/Desktop/pyve/VisionApi/downloadimage/%1d.jpg -frames:v '+str(filenumber)+' video.mp4')
if __name__ == '__main__':
        #f = get_all_tweets('@OnePlus_USA',30)
        #googlevision(f)
        Image2Video(9)